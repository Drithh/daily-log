...
>   
    ...
    <form method="POST" class="wrapper flex place-content-end gap-6 flex-col px-4">
        <input
            id="title"
            name="title"
        ...
        ></textarea>
        <button  class="rounded border border-secondary py-2 px-10 border-opacity-50 hover:border-blue-500">Submit</button>
    </form>
</div>
